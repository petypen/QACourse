...
Функционал: экспорт констант демонстрационного приложения

Как администратор я хочу
загружать значения констант в новую пустую конфигурацию
чтобы иметь возможность тестировать эту конфигурацию с конкретными настройками
