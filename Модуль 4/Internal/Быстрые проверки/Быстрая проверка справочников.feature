...
Функционал: Быстрая проверка справочников, как дымовые тесты

Как тестировщик я хочу
Проверить открытие всех форм справочников
чтобы убедиться, что после обновления ничего не сломалось 
